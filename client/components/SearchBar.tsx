...
export default function SearchBar({title, setTitle, colors, executeSearch}: SearchBarProps) {
    ...
    <View style={{
        ...
        alignItems: 'center',
            ...
            <TextInput mode="outlined"
                ...
                theme={{roundness: 30}}
                right={<TextInput.Icon icon={(props) => <EIcon onPress={executeSearch} name="search" size={props.size+10} color={props.color} style={{paddingBottom: 7}}/>}/>}
