        ...
        <SafeAreaView  style={{flex: 1}}>
          <ScrollView keyboardShouldPersistTaps="always">
            {workoutInCreation?.exercises.map(exercise => (
              <WorkoutExerciseCard key={exercise.exercise_id} exercise={exercise} colors={colors} addSet={addSet} editValue={editValue}/>
            ))}
...
const WorkoutExerciseCard = ({exercise, colors, addSet, editValue}: 
  {exercise: WorkoutExercise, colors: MD3Colors, addSet: addSetFunction, editValue: editValueFunction}) => {
...
const WorkoutTabelCell = ({value, onChange}: {value: number, onChange: (t: string) => void}) => {
